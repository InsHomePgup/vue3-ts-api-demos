<template>
  <div class="font-sans p-5 bg-[#f0f2f5] min-h-100vh">
    ...
    <div class="bg-white p-5 rounded-lg mb-8 shadow-sm">
      <h2 class="mt-0 text-[#333]">1. 兄弟元素外边距合并</h2>
      ...
      <div class="bg-[#e6f7ff] border-2 border-dashed border-[#1890ff]">
        <div class="w-full h-[100px] text-white flex items-center justify-center font-bold bg-[#ff7875] mb-[30px]">下外边距: 30px</div>
        <div class="w-full h-[100px] text-white flex items-center justify-center font-bold bg-[#40a9ff] mt-[30px]">上外边距: 30px</div>
      </div>
    </div>

    <!-- Case 2: Preventing Sibling Margin Collapsing with BFC Wrapper -->
    <div class="bg-white p-5 rounded-lg mb-8 shadow-sm">
      <h2 class="mt-0 text-[#333]">2. 解决兄弟元素外边距合并（包裹在 BFC 中）</h2>
      <p class="text-[#666] mb-5 leading-relaxed">
      ...
      <div class="bg-[#e6f7ff] border-2 border-dashed border-[#1890ff]">
        ...
        <!-- Wrapper with BFC -->
        <div class="flow-root">
          <div class="w-full h-[100px] text-white flex items-center justify-center font-bold bg-[#40a9ff] mt-[30px]">上外边距: 30px (包裹在 BFC 中)</div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white p-5 rounded-lg mb-8 shadow-sm">
      <h2 class="mt-0 text-[#333]">3. 父子元素外边距合并（问题）</h2>
      <p class="text-[#666] mb-5 leading-relaxed">
      ...
      <div class="bg-[#fff1f0] outline-2 outline-dashed outline-[#ff4d4f]">
        <div class="w-[100px] h-[100px] bg-[#ff4d4f] mt-[50px] text-white flex items-center justify-center mx-auto">子元素 (上外边距 50px)</div>
      </div>
    </div>

    <!-- Case 4: Solving Parent-Child Margin Collapsing with BFC -->
    <div class="bg-white p-5 rounded-lg mb-8 shadow-sm">
      <h2 class="mt-0 text-[#333]">4. 解决父子元素外边距合并（使用 BFC）</h2>
      <p class="text-[#666] mb-5 leading-relaxed">
